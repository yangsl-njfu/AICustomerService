...
class OrderQueryNode(BaseNode):
    ...
    def _is_cancel_order_request(self, user_message: str) -> bool:
        return any(keyword in user_message for keyword in self.CANCEL_ORDER_KEYWORDS)

    def _build_order_quick_actions(self, target_order: dict, items: list, order_no: str) -> list:
        quick_actions = []
    ...
    async def execute(self, state: ConversationState) -> ConversationState:
        ...
        if order_no_match:
            ...
            async with get_db_context() as db:
                ...
                if self._is_cancel_order_request(user_message):
                    try:
                        ...
                        state["quick_actions"] = self._build_order_quick_actions(target_order, items, order_no)
                        return state
